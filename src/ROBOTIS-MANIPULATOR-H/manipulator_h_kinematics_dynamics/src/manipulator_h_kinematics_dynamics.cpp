...
ManipulatorKinematicsDynamics::ManipulatorKinematicsDynamics(TreeSelect tree)
{
  ...
  if (tree == ARM)
  {
    ...
    manipulator_link_data_[4]->parent_  = 4;
    manipulator_link_data_[4]->sibling_ = -1;
    manipulator_link_data_[4]->child_   = 6;
    manipulator_link_data_[4]->mass_    = 0.491;
    manipulator_link_data_[4]->relative_position_ = robotis_framework::getTransitionXYZ(0.06300, 0.04500, 0.00000);
    manipulator_link_data_[4]->joint_axis_        = robotis_framework::getTransitionXYZ(0.0, 1.0, 0.0);
    ...
    manipulator_link_data_[5]->parent_  = 5;
    manipulator_link_data_[5]->sibling_ = -1;
    manipulator_link_data_[5]->child_   = 7;
    manipulator_link_data_[5]->mass_    = 0.454;
    manipulator_link_data_[5]->relative_position_ = robotis_framework::getTransitionXYZ(0.12300, -0.04500, 0.00000);
    manipulator_link_data_[5]->joint_axis_        = robotis_framework::getTransitionXYZ(1.0, 0.0, 0.0);
